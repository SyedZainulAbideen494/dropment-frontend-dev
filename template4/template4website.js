...
const Template4website = (props) => {
  ...
  return (
    <div>
      <Editbtndisplay1 />
      <div className="temp4header">
        <header>
          <div className="txtshopnametemp4">
            <h1>Shop name</h1>
            <div className="btnviewprods">
              <button onClick={scrollToItems}>
                <h3>View Items</h3>
              </button>
            </div>
            <div className="slaestxt">
              <h2>Slaes text</h2>
            </div>
          </div>
        </header>
      ...
      <div className="aboutuspg1" id="abt1pg1">
        <span className="txttem1is4">
          <h1>shop our products(block 1)</h1>
        </span>
        <span className="btnfortemp1is4">
          <button onClick={scrollToItems}>View</button>
        </span>
      </div>
      <div className="aboutuspg2" id="abt1pg1">
        <span className="txttem1is4">
          <h1>shop our products(block 2)</h1>
        </span>
        <span className="btnfortemp1is4">
          <button onClick={scrollToItems}>View</button>
        </span>
      ...
      <div className="contactpg">
        <h3>Contact us</h3>
        <span className="infocontact">Eample@gmail.com</span><br/>
        <span className="infocontact">1888777999</span><br/>
        <span className="infocontact">@instagram</span><br/>
      </div>
    </div>
  );
};
