...
import fashion4 from '../header/images/Untitled design (27).jpg'
      ...
      <div className="temp6base">
        ...
        <div className="temp6header">
          <header>
            ...
            <br />
            <h2>Sales text</h2>
            <div className="btntopheqader">
              <button onClick={scrollToItems}>Shop Now</button>
            </div>
          </header>
        </div>
        <div className="blockset1">
          <div className="blockno1">
            <section></section>
          </div>
          <div className="blockno2">
            <section></section>
          </div>
          <div className="blockno3">
            <section></section>
          </div>
        </div>
        <div className="blockset2">
          <div className="blockset2no1">
            <section className="blockset2no1img"></section>
            <section className="blockset2no1txt">
              <div className="headblockset2no1txthead">
                <h1>Block 1 heading</h1>
              </div>
              <div className="txtdetailsblockset2no1">
                <h3>Details about the heading above</h3>
              </div>
            </section>
          </div>
          <div className="blockset3">
            <section className="blockset3txt">
              <div className="txtheadblockset3">
                <h1>Heading block 2</h1>
              </div>
              <div className="detailstxtblockset3">
                <h3>details about above heading</h3>
              </div>
            </section>
            <div className="blockset3imgs">
              <section className="imgblockset31"></section>
              <section className="imgblockset32"></section>
              <section className="imgblockset33"></section>
            </div>
          </div>
        </div>
        <div className="temp6prodsection" ref={itemsRef}>
          <section>
            <div className="prodssechead">
              <h2>Our Products</h2>
            </div>
        ...
        <div className="aboutblocks" ref={aboutusRef}>
          <div className="abtblock1">
            <section className="abtblock1img"></section>
            <section className="abtblock1txt">
              <h1>Heading</h1>
              <h3>About the heading written above</h3>
            </section>
          </div>
          <div className="abtblock2">
            <section className="abtblock2txt">
              <h1>Heading</h1>
              <h3>About the heading written above</h3>
            </section>
            <section className="abtblock2img"></section>
          </div>
          <div className="abtblock1">
            <section className="abtblock3img"></section>
            <section className="abtblock1txt">
              <h1>Heading</h1>
              <h3>About the heading written above</h3>
            </section>
        ...
        <div className="contactus">
          <section>
            ...
            <div className="allcontacts" ref={contactusRef}>
              <span>
                <h3>Example@gamil.com</h3>
              </span>
              <br />
              <span>
                <h3>888 888 8881</h3>
